// example from https://www.shadertoy.com/view/4dl3R4
//http://glslsandbox.com/e#46599.3
Shader "Unlit/HeavySnow"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
                ...
                vec2 uv = i.uv.xy / _Resolution.xy;
                ...
                return vec4(Snowout*0.9, Snowout, Snowout*1.1, 1.0);
			}
			ENDCG
		}
	}
